...
for train_index, test_index in skf.split(data_concat, label):
    ...
    lstm1 = LSTM(8, activation='relu', kernel_regularizer=l2(l2_value), bias_regularizer=l2(l2_value))(reshape1)
    flat1 = Flatten()(lstm1)
    ...
    lstm2 = LSTM(8, activation='relu', kernel_regularizer=l2(l2_value), bias_regularizer=l2(l2_value))(reshape2)
    flat2 = Flatten()(lstm2)
    ...
    lstm3 = LSTM(8, activation='relu', kernel_regularizer=l2(l2_value), bias_regularizer=l2(l2_value))(reshape3)
    flat3 = Flatten()(lstm3)
